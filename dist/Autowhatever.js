...
var Autowhatever = function (_Component) {
  ...
  _createClass(Autowhatever, [{
    ...
    value: function onKeyDown(event) {
      ...
      var allowNullFocus = _props4.allowNullFocus;
    ...
    value: function render() {
      ...
      var input = renderInput(inputProps);
...
Autowhatever.propTypes = {
  ...
  renderInput: _react.PropTypes.func, // This function renders the input element
  ...
  allowNullFocus: _react.PropTypes.bool, // Should using arrow keys to navigate options result in null options
